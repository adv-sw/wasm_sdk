...
%CPP% %HEADERS% %COMPILE_OPTIONS% ./source/inf_entity.cpp  -o ./obj/inf_entity.o 
%CPP% %HEADERS% %COMPILE_OPTIONS% ./source/program.cpp  -o ./obj/program.o 
...
%WASM_TOOLS%\wasm-ld %LINK_OPTIONS%  %LIBS% ./obj/inf_entity.o  ./obj/program.o -o ./obj/app.wasm


rem ======= Install =======

rem Push to distribution ...
copy .\obj\app.wasm ..\..\website\game\_action > nul
